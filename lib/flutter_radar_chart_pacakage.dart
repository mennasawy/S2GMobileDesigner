...
//  Colors.orange,
//];
const defaultGraphColors = Colors.blue;
...
//  final List<Color> graphColors;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    features.asMap().forEach((index, feature) {
      ...
      var featureLabelFontWidth =
          (featuresTextStyle as TextStyle).fontSize - feature.length + 1;
...
//        ..style = PaintingStyle.fill;
      var graphPaint = Paint()
        ..color = graphColors.withOpacity(0.3)
        ..style = PaintingStyle.fill;
