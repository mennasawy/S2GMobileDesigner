...
class Temp2DigitalSignatureUDA extends StatefulWidget {
  final String title;
  ...
  const Temp2DigitalSignatureUDA(
      {Key key,
      this.title,
      ...
      : super(key: key);
  @override
  _Temp2DigitalSignatureUDAState createState() =>
      _Temp2DigitalSignatureUDAState();
}

class _Temp2DigitalSignatureUDAState extends State<Temp2DigitalSignatureUDA> {
  ...
  Widget imageUDAWidget() {
    return newSignatureImage == null && widget.imageValue == null
        ? emptyImageWidget(
            onButtonTapped: () => showPopupSigniture(context),
            isMandatory: widget.isMandatory,
            title: widget.title,
            buttonTitle: "E-Signature",
          )
        : GestureDetector(
            child: deletePickedImageWidget(),
            onTap: () => showPopupSigniture(context));
  }
  ...
  Widget deletePickedImageWidget() {
    return Stack(
      children: [
        selectedImageWidget(context, getSavedOrPickedImage(), getImageTitle()),
        Align(
