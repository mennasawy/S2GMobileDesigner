...
//                        autovalidate: true,
                        ...
                        decoration: dropDownInputDecoration ??
                            getInputDecoration(context, hintText,
                                (hasIcon) ? IC_DROPDOWN : null, GREY, null),
                        style: FontUtils.dynamicHintsTextStyle(
                            BLACK, (titleFontSize ?? 0.035), context),
                ...
                drawWidgetOrEmptyContainer(
                  ...
                  Container(
                    decoration: BoxDecoration(
                        ...
                        borderRadius:
                            BorderRadius.circular(TEXTFIELD_BORDER_RADUIS)),
...
class DropDownFieldState extends FormFieldState<String> {
  ...
  void initState() {
    ...
    widget.items = removeEmptyItem(widget.items);
  ...
  onFocusChange() {
    setState(() {
      log(LogType.INFO, "Focus: " + _focus.hasFocus.toString());
      if (!_focus.hasFocus)
        _showdropdown = false;
      else
        _showdropdown = true;
