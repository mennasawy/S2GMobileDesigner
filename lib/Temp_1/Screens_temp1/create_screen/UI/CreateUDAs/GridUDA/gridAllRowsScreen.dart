...
import 'package:templets/Temp_1/Screens_temp1/create_screen/UI/CreateUDAs/GridUDA/grid_name_item.dart';

class GridAllRowsScreen extends StatefulWidget {
  ...
  @override
  _GridAllRowsScreenState createState() => _GridAllRowsScreenState();
}

class _GridAllRowsScreenState extends State<GridAllRowsScreen>
            ...
            widget.gridRowsValues.length == null ||
                ...
                : Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, rowIndex) => GridNameItem(
  ...
  Widget _buildIconActions() {
    Widget addIcon = IconButton(
      ...
      onPressed: allRowsPresenter.onAddNewRowTapped,
      ...
      //                     ))).then((value) async {
      //           if (value != null)
      //             await allRowsPresenter.refreshRowsList(value);
      //         });
      //       }
      //     : null
    );
